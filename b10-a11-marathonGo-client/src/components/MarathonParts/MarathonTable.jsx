    ...
    return (
        <div className='w-[90%] mx-auto mt-14     '>
            <div className='flex justify-between items-center   mb-4 md:mb-8 '>
                <h3 className='font-semibold text-black text-2xl ml-1 md:ml-2   '> All Marathons here </h3>
                <button onClick={handleSortMarathons} className="bg-green-400 hover:bg-green-900 hover:text-white transition-colors duration-200 px-6 py-1 font-medium rounded-md text-black"> Sort  </button>
            </div>
