...
const HomeMission = () => {
    return (
        <div>
            <section className="w-[85%] bg-[#E7E8D1] md:w-[60%] lg:w-[60%] mx-auto px-5 lg:px-20 py-10 rounded-2xl">

                <h3 className="text-2xl lg:text-3xl text-blue-950 font-bold mb-4 dark:text-gray-200 text-center">
                ...
                <p className="w-[90%] mx-auto lg:w-[90%] text-gray-800 dark:text-gray-300 text-sm lg:text-xl leading-relaxed text-center">
